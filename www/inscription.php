...
if(isset($_POST['enregistrer'])){
  ...
  //Définition des variables ci-dessous
...
//envoi de la requête dans la db avec nos variables 
$req = "INSERT INTO users(nom, prenom, email, password) VALUES(?,?,?,?)";

//Préparation de l'éxecution des valeurs dans la db
$execute = $pdo->prepare($req);

//Execute la reqûete précédente en écrivant les valeurs dans la db
$stm = $execute->execute([$nom, $prenom, $email, $password]);
echo "<center>Bravo vous êtes bien inscris !</center>";
